# Arbeitspaket AP-04: cost-tracking

## Ziel
Kostenhistorie, Jahresvergleich, Aggregationen und Dashboard-Auswertungen.
...
Arbeite in einem neuen Branch `feat/AP-04-cost-tracking` auf Basis des aktuellen `main`. Direkte Änderungen an `main` sind verboten.

Aufgabe:
Kostenhistorie, Jahresvergleich, Aggregationen und Dashboard-Auswertungen.

Akzeptanzkriterien:
- Kostenpositionen besitzen Gültigkeitszeiträume und Zahlungsfrequenz.
- Jahreskosten werden nachvollziehbar berechnet.
- Beitragserhöhungen gegenüber dem Vorjahr sind sichtbar.
- Berechnungslogik ist unit-getestet, inklusive Sonderfällen für unterjährige Zeiträume.
- Die UI zeigt Kosten pro Vertrag und aggregiert pro Haushalt.
